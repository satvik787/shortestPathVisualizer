...
const star:HTMLImageElement = <HTMLImageElement> document.getElementById("star");
const target:HTMLImageElement = <HTMLImageElement> document.getElementById("target");
const ctx:CanvasRenderingContext2D = <CanvasRenderingContext2D> canvas.getContext("2d");
const startBtn = <HTMLElement> document.getElementById("btn_start");
const bfsBtn = <HTMLElement> document.getElementById("algo_bfs");
const dfsBtn = <HTMLElement> document.getElementById("algo_dfs");
const gridMenu = <HTMLElement> document.getElementById("grid_menu");
const algoMenu = <HTMLElement> document.getElementById("algo_menu");
const gridBtn = <HTMLElement> document.getElementById("grid_btn");
const algoBtn = <HTMLElement> document.getElementById("algo_btn");
const clearBoardBtn = <HTMLElement> document.getElementById("btn_clear_board");
...
let step = 1;
let mat:Array<Array<Array<number>>>;
let sr:number,sc:number,dr:number,dc:number;
let algo:Visualizer
...
function mouseMoveHandler(e:MouseEvent){
    ...
    if(state !== CELL_STATE.empty)return;
...
canvas.addEventListener("mouseup",()=>{
    if(step === 3)canvas.removeEventListener("mousemove",mouseMoveHandler);
});
